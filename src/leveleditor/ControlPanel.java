...
public class ControlPanel {
    ...
    private class NameRendered extends DefaultListCellRenderer {
        @Override
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            if (value instanceof FakeBody)
                value = ((FakeBody) value).getName(); //make it render name not toString (used for connecting doors)
    ...
    public ControlPanel() {
        ...
        addDoorCB.setRenderer(new NameRendered());
        doorList.setCellRenderer(new NameRendered());
        cardLayout = (CardLayout) extraOptions.getLayout();
        clearAll();

        newBodySelector.addItem("BoxStaticBody");
        newBodySelector.addItem("CircleStaticBody");
        newBodySelector.addItem("SlidingDoor");
        newBodySelector.addItem("Crate");
        newBodySelector.addItem("Ball");
        newBodySelector.addItem("Button");
        newBodySelector.addItem("Exit");
        newBodySelector.addItem("Player");
